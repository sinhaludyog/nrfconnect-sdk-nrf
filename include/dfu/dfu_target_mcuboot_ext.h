...
/** @file dfu_target_mcuboot_ext.h
 *
 * @defgroup dfu_target_mcuboot_ext MCUBoot DFU Target
 * @{
 * @brief DFU Target for upgrades performed by MCUBoot
 */

#ifndef DFU_TARGET_MCUBOOT_EXT_H__
#define DFU_TARGET_MCUBOOT_EXT_H__
 ...
 */
int dfu_target_mcuboot_ext_offset_get(size_t *offset);
...
#endif /* DFU_TARGET_MCUBOOT_EXT_H__ */
